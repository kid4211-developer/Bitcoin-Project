...
const withSelectedCoinName = () => (OriginalComponent) => (props) => {
    ...
    const coinNameKor = useSelector((state) => state.Coin.marketNames.data[selectedMarket].korean)
    const coinNameEng = useSelector((state) => state.Coin.marketNames.data[selectedMarket].english)
